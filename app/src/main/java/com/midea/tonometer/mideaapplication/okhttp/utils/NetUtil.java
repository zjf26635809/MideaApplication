package com.midea.tonometer.mideaapplication.okhttp.utils;
...
public class NetUtil {
	...
	public static boolean isWifi(){
		ConnectivityManager manager = (ConnectivityManager) MWApplication.getContext()
				.getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	public static boolean isNetAvailable() {
		...
		if (!NetUtil.isConnected(MWApplication.getContext())) {
			// "当前网络已断开,请检查网络后重试");
			CommonUtils.toast_s("当前网络已断开,请检查网络后重试");
			return false;
